...
.nonrest/src/main/java/Employee/EmployeeRepository.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/Employee/EmployeeRepository.java[]
----
...
.nonrest/src/main/java/Employee/PayrollApplication.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/Employee/PayrollApplication.java[]
----
...
.nonrest/src/main/java/Employee/LoadDatabase.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/Employee/LoadDatabase.java[]
----
...
----
...
2018-08-09 11:36:26.169  INFO 74611 --- [main] Employee.LoadDatabase : Preloading Employee(id=1, name=Bilbo Baggins, role=burglar)
2018-08-09 11:36:26.174  INFO 74611 --- [main] Employee.LoadDatabase : Preloading Employee(id=2, name=Frodo Baggins, role=thief)
...
----
...
.nonrest/src/main/java/Employee/EmployeeController.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/Employee/EmployeeController.java[]
----
...
.nonrest/src/main/java/Employee/EmployeeNotFoundException.java
[source,java,tabsize=2]
----
include::nonrest/src/main/java/Employee/EmployeeNotFoundException.java[]
----

When an `EmployeeNotFoundException` is thrown, this extra tidbit of Spring MVC configuration is used to render an *HTTP 404*:

.nonrest/src/main/java/Employee/EmployeeNotFoundAdvice.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/Employee/EmployeeNotFoundAdvice.java[]
----
...
----
include::rest/src/main/java/Employee/EmployeeController.java[tag=get-single-item]
----
...
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/Employee/EmployeeController.java[tag=get-aggregate-root]
----
...
[source,java,tabsize=2,indent=0]
----
include::rest/src/main/java/Employee/EmployeeController.java[tag=get-aggregate-root]
----
...
.evolution/src/main/java/Employee/EmployeeModelAssembler.java
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/Employee/EmployeeModelAssembler.java[]
----
...
----
include::evolution/src/main/java/Employee/EmployeeController.java[tag=constructor]
...
----
include::evolution/src/main/java/Employee/EmployeeController.java[tag=get-single-item]
----
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/Employee/EmployeeController.java[tag=get-aggregate-root]
----
...
----
include::evolution/src/main/java/Employee/Employee.java[]
----
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/Employee/LoadDatabase.java[tag=new_constructor]
----
====
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/Employee/EmployeeController.java[tag=post]
----
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/Employee/EmployeeController.java[tag=put]
----
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/Employee/EmployeeController.java[tag=delete]
----
...
.links/src/main/java/Employee/Order.java
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/Employee/Order.java[]
----
...
.links/src/main/java/Employee/Status.java
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/Employee/Status.java[]
----
...
.links/src/main/java/Employee/OrderController.java
[source,java,tabsize=2]
----
include::links/src/main/java/Employee/OrderController.java[tag=main]
}
----
...
.links/src/main/java/Employee/OrderModelAssembler.java
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/Employee/OrderModelAssembler.java[]
----
...
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/Employee/OrderController.java[tag=delete]
----
...
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/Employee/OrderController.java[tag=complete]
----
...
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/Employee/LoadDatabase.java[]
----
